...
violationTracker : function(parentCo, callback){
  async.waterfall([
...
subsidyTracker : function(parentCo, callback){
  async.waterfall([
...
GJFsearch : function(parentCo, callback){
  var GJFresults = {};
  async.series([
    function(callback){
...
//Bloomberg Functions
bloombergSearch : function(parentCo, callback){
  async.waterfall([
...
presentationAPIsearch : function(parentCo, callback){
...
corpwatchSearch : function(someCompany, callback){
  async.waterfall([
...
cwPASwaterfall : function(someCompany, callback){
  async.waterfall([
...
searchForEach : function(relatedCompanies, callback){
    var totalResults={};
...
relatedCompanies : function(req, callback){
...
wholeEnchilada: function(req,callback){
  async.waterfall([
